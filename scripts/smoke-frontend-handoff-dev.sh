...
[[ "$API_DOMAIN_LEGACY" == "api-dev.zetruv.dualangka.com" ]] || { echo "Unexpected DEV API_DOMAIN_LEGACY: $API_DOMAIN_LEGACY" >&2; exit 1; }
[[ "$FRONTEND_ORIGIN" == "https://dev.zetruv.com" ]] || { echo "Unexpected DEV FRONTEND_ORIGIN: $FRONTEND_ORIGIN" >&2; exit 1; }
[[ "$FRONTEND_ORIGIN_LEGACY" == "https://dev.zetruv.dualangka.com" ]] || { echo "Unexpected DEV FRONTEND_ORIGIN_LEGACY: $FRONTEND_ORIGIN_LEGACY" >&2; exit 1; }
...
echo '4/6 CORS from new DEV frontend'
...
echo 'PASS: DEV zetruv.com backend cutover is healthy; new API/origin are primary and dualangka.com remains a temporary alias.'
